      ...
      <div className="container">
        <div className="row">
          ...
          >
            ...
            <h1 className="h1header">Você ainda não tem um site?<br/>
            <nr/> Dê vida a seu negócio. Exista na internet!</h1>

            <br/>

            <h2 className="h2header">Qual maior site de buscas? Não precisamos nem pensar "Google" é claro. 
            Pense, seu site é o cartão de visitas para seu cliente. Dá mais credibilidade uma pequena empresa ou 
            seu trabalho pessoal tendo um site com suas descrições mais completas, além da proporção de clientes que você possa atingir.</h2>
            <div className="">
      <a
